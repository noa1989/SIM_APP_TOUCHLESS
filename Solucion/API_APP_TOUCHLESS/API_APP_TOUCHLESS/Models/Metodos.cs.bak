    ...
    public class Metodos
    {
        ...
        public static void SP_WS_DATOS_GDE(VM_Recep DATA)
        {
            ...
            try
            {
                ...
                OracleCommand CMD = new OracleCommand();
                CMD.Connection = CON;
                CMD.CommandText = Parametros._PACKAGE + "SP_WS_DATOS_GDE";
                CMD.CommandType = CommandType.StoredProcedure;

                CMD.Parameters.Add("PN_RUT", OracleType.Number).Value = Parametros.VALIDA_NULO (DATA.PROVEEDOR_RUT) ;
                CMD.Parameters.Add("PN_GUIA", OracleType.Number).Value = Parametros.VALIDA_NULO(DATA.GUIA);
                CMD.Parameters.Add("PV_PDF417", OracleType.VarChar, 500).Value = Parametros.VALIDA_NULO(DATA.PDF417);
