...
namespace API_APP_TOUCHLESS.Models
{
    public class Metodos
    {
        ...
        public static void SP_WS_CHOFER(VM_Chofer DATA)
        {
            ...
            try
            {
                ...
                DATA.CHOFER.ERROR_COD = Convert.ToInt32(Parametros.VALIDA_DBNULL(CMD.Parameters["PN_NRO_ERROR"].Value));
                DATA.CHOFER.ERROR_DSC = Parametros.VALIDA_DBNULL(CMD.Parameters["PV_MSG_ERROR"].Value.ToString());
            ...
            catch (Exception EX)
            {
                ...
                DATA.CHOFER.ERROR_COD = 1;
                DATA.CHOFER.ERROR_DSC = EX.Message;
        ...
        public static void SP_WS_PROVEEDOR(VM_Proveedor DATA)
        {
            ...
            try
            {
                ...
                DATA.PROVEEDOR.ERROR_COD = Convert.ToInt32(Parametros.VALIDA_DBNULL(CMD.Parameters["PN_NRO_ERROR"].Value));
                DATA.PROVEEDOR.ERROR_DSC = Parametros.VALIDA_DBNULL(CMD.Parameters["PV_MSG_ERROR"].Value.ToString());
            ...
            catch (Exception EX)
            {
                ...
                DATA.PROVEEDOR.ERROR_COD = 1;
                DATA.PROVEEDOR.ERROR_DSC = EX.Message;
        ...
        public static void SP_WS_DESTINO(VM_Listas_Destinos DATA)
        {
        ...
        public static void SP_WS_EEPP(VM_Listas_EEPP DATA)
        {
            ...
            try
            {
                ...
                OracleCommand CMD = new OracleCommand();
                CMD.Connection = CON;
                CMD.CommandText = Parametros._PACKAGE + "SP_WS_EEPP";
                CMD.CommandType = CommandType.StoredProcedure;
        ...
        public static void SP_WS_CANCHA_PROCEDENCIA(VM_Listas_Canchas_Proc DATA)
        {
            ...
            try
            {
                ...
                OracleCommand CMD = new OracleCommand();
                CMD.Connection = CON;
                CMD.CommandText = Parametros._PACKAGE + "SP_WS_CANCHA_PROCEDENCIA";
                CMD.CommandType = CommandType.StoredProcedure;
        ...
        public static void SP_WS_PEDIDO_COMPRA(VM_Listas_Pedido DATA)
        {
        ...
        public static void SP_WS_COMUNAS(VM_Listas_Comunas DATA)
        {
            ...
            try
            {
                ...
                OracleCommand CMD = new OracleCommand();
                CMD.Connection = CON;
                CMD.CommandText = Parametros._PACKAGE + "SP_WS_COMUNAS";
                CMD.CommandType = CommandType.StoredProcedure;
