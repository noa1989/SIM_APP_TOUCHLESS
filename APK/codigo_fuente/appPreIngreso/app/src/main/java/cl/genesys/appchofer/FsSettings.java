...
public class FsSettings {
    ...
    public static File getDefaultChrootDir() {
        ...
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            chrootDir = new File(Environment.getExternalStorageDirectory() + "/cl.genesys.appchofer/sinc/");
            if (!chrootDir.exists()){
                chrootDir.mkdirs();
            }
        } else {
    ...
    public static File getDefaultChrootDirRecepcion() {
        File chrootDir;
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            chrootDir = new File(Environment.getExternalStorageDirectory() + "/cl.genesys.appchofer/recepcion/");
            if (!chrootDir.exists()){
                chrootDir.mkdirs();
            }
        } else {
