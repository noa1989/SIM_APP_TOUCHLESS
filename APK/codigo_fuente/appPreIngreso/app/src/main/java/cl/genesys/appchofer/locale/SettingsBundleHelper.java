...
public final class SettingsBundleHelper {
    ...
    public static final String BUNDLE_BOOLEAN_RUNNING = "cl.genesys.appchofer.BOOLEAN_RUNNING";
    public static final String BUNDLE_VERSION_CODE = "cl.genesys.appchofer.VERSION_CODE";
