...
import cl.genesys.appchofer.gui.FsNotification;
import cl.genesys.appchofer.server.SessionThread;
import cl.genesys.appchofer.server.TcpListener;
import lombok.val;
...
public class FsService extends Service implements Runnable {
    ...
    static public final String ACTION_REQUEST_START = "cl.genesys.appchofer.REQUEST_START";
    static public final String ACTION_REQUEST_STOP = "cl.genesys.appchofer.REQUEST_STOP";

    // Service will (global) broadcast when server start/stop
    static public final String ACTION_STARTED = "cl.genesys.appchofer.FTPSERVER_STARTED";
    static public final String ACTION_STOPPED = "cl.genesys.appchofer.FTPSERVER_STOPPED";
    static public final String ACTION_FAILEDTOSTART = "cl.genesys.appchofer.FTPSERVER_FAILEDTOSTART";
